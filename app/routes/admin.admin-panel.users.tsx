        ...
        <div className="d-flex flex-column p-2">
          {tab == "users" ? (
            <>
              ...
              >
                <div className="d-flex flex-row border-bottom" style={{width: "max-content"}}>
                  ...
                  <p className="border-end p-2 m-0" style={{ width: 600 }}>
                    PASS HASH
                  </p>
                </div>
                {user_db.map((El) => {
                  return (
                    <>
                      ...
                      >
                        ...
                        <a
                          href={"/admin/delUser/" + El.id}
                          className="text-light m-0 p-2 bg-danger"
                        >
                          Удалить
                        </a>
                        <a
                          href={"/admin/chgUser/" + El.id}
                ...
                <a
                  href={"/admin/addUser/"}
                  className="p-3 m-0 bg-success text-light mt-3 rounded"
                  style={{ width: "max-content" }}
                >
